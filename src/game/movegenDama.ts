...
function generateRawCaptureMovesFrom(
  ...
  for (const { dr, dc } of dirs) {
    // Capture-direction rule (Dama + Damasca): during a capture chain, an Officer may
    // continue in the same direction (0°) or turn left/right (±90°), but may NOT reverse (180°).

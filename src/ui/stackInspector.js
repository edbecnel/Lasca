// src/ui/stackInspector.js

import { MINI_SPINE_MAX_SHOWN, MINI_SPINE_KEEP_BOTTOM, MINI_SPINE_KEEP_TOP } from "../config/constants.js";
import { pieceToHref } from "../pieces/pieceToHref.js";
import { makeUse } from "../render/svgUse.js";

const SVG_NS = "http://www.w3.org/2000/svg";

/**
 * Stack Inspector: hover a stack and show the full stack order in the right panel.
 * If the mini-spine is cracked, draw brackets around the omitted middle group here.
 */
export function createStackInspector(zoomTitle, zoomHint, zoomSvg){
  let hideTimer = null;
  ...
  function show(nodeId, stack){
    ...
    zoomSvg.setAttribute("height", String(H)); // allow scroll in the panel when needed
    ...
    // Brackets around the missing middle group when the mini spine is cracked
  ...
  function hideSoon(){
    ...
    hideTimer = setTimeout(() => {
      ...
      zoomHint.textContent = "Hover a stacked piece to see the full column order (bottom → top). If a crack appears on the mini spine, brackets mark the omitted middle here.";
      clearZoom();
    }, 80);
  }
